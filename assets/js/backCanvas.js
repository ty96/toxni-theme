function loadJS(A, e, t) {
  var o = !!window.ActiveXObject, i = o && !window.XMLHttpRequest, a = document.createElement("script"), n = i ? document.documentElement : document.getElementsByTagName("head")[0];
...
var duoshuoQuery = {short_name: "snowz"}, GlobalConfigue = {duoshuoDomain: "https://snowz.me"}, General = {
  isMobile: !1,
  isWechat: !1,
  ...
  webFontLoader: function () {
    WebFontConfig = {
      loading: function () {
      }, custom: {families: ["Exo", "iconfont"], urls: [General.absUrl + "/assets/css/font.min.css"]}
  ...
  addIcons: function () {
    $(".single-post-inner  a:not(:has(img))").each(function (A) {
      ...
      var o = $(this).find("i").css("color"), i = $(this).css("color");
      $(this).hover(function () {
  ...
  rewardLoader: function () {
    var A = {alipay: "/assets/images/qr-alipay-256.png", wechat: "/assets/images/qr-wechat-256.png"};
...
$(document).ready(function () {
  ...
  $.fn.lazyload = function (e) {
    function t() {
      ...
      i.each(function () {
        var e = $(this);
        if (!a.skip_invisible || e.is(":visible"))if ($.abovethetop(this, a) || $.leftofbegin(this, a)); else if ($.belowthefold(this, a) || $.rightoffold(this, a)) {
